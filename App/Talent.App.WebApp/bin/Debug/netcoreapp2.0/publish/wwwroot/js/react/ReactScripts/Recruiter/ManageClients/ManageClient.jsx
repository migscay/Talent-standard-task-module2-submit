...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://talent-profile.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'https://talent-identity.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
