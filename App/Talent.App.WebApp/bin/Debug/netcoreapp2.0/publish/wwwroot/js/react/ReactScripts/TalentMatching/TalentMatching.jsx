...
export default class TalentMatching extends React.Component {
    ...
    //loadJobs(data) { // url: 'https://talent-listing.azurewebsites.net/listing/listing/getEmployerJobs',
        
    //loadSelectedJob(data) url: 'https://talent-listing.azurewebsites.net/listing/listing/getJobForTalentMatching',

    //loadTalentList()  url: 'https://talent-profile.azurewebsites.net/profile/profile/getTalentList',

    //loadTalentFilterList() //url: 'https://talent-profile.azurewebsites.net/profile/profile/getTalentListFilter',

    //loadEmployerFilterList() //url: 'https://talent-profile.azurewebsites.net/profile/profile/getEmployerListFilter',


    // loadEmployerList() // url: 'https://talent-profile.azurewebsites.net/profile/profile/getEmployerList',
    //loadSuggestionList   url: 'https://talent-profile.azurewebsites.net/profile/profile/getSuggestionList',

   // saveCompanyTalents()   url: 'https://talent-profile.azurewebsites.net/profile/profile/addTalentSuggestions',
     

    //saveJobTalents()    url: 'https://talent-profile.azurewebsites.net/profile/profile/addTalentSuggestions',
