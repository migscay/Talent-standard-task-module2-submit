...
export default class SocialMediaLinkedAccount extends React.Component {
    ...
    renderDisplay() {
        let linkedIn = this.props.linkedAccounts.linkedIn ? `${this.props.linkedAccounts.linkedIn}` : 'https://www.linkedin.com/'
        let github = this.props.linkedAccounts.github ? `${this.props.linkedAccounts.github}` : 'https://github.com/'
