...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talent-profile.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
            ...
            success: function (res) {
                console.log("getTalentProfile",res.data)
    ...
    updateForComponentId(componentId, newValues) {
        console.log("updateForComponentId",componentId,newValues);
        let data = {};
    ...
    saveProfile() {
        console.log("saveProfile",this.state.profileData)
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talent-profile.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                                    ...
                                    <div className="ui grid">
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl='https://talent-profile.azurewebsites.net/profile/profile/updateProfilePhoto'
                                            />
                                        </FormItemWrapper>
                                        {/* <FormItemWrapper
                                            title='Profile Video'
                                        ...
                                        >
                                            <VideoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveVideoUrl={'https://talent-profile.azurewebsites.net/profile/profile/updateTalentVideo'}
                                            />
                                        </FormItemWrapper> */}
                                        {/* <FormItemWrapper
                                            title='CV'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={'https://talent-profile.azurewebsites.net/profile/profile/updateTalentCV'}
                                            />
                                        </FormItemWrapper> */}
                                        {/* <SelfIntroduction
                                            summary={this.state.profileData.summary}
